...
No `requirements.txt`/`pyproject.toml` exists — dependencies are whatever's in the global Python 3.12 install at `C:\Users\franc\AppData\Local\Programs\Python\Python312\`.
